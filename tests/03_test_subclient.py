...
from test_client import sub_client, callback, error_handler
...
sub_client.subscribe_aggregate_trade_event(symbol="btcusdt", callback=callback, error_handler=error_handler)
sub_client.subscribe_aggregate_trade_event(symbol="btcusdt", callback=callback, error_handler=error_handler)
